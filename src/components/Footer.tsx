...
const Footer = ({ producer }: { producer: Producer }) => {
  return (
    <footer className="bg-black backdrop-blur-sm p-4 border-t border-white/10">
            ...
            <div className="flex flex-wrap w-full gap-4">
              {producer.phone && (
                <a
                  ...
                  className="flex items-center gap-2 text-white hover:text-emerald-600 transition-colors duration-300"
                >
